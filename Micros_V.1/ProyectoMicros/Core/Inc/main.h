...
/* Private defines -----------------------------------------------------------*/
#define ADC1 hadc1
#define BOTON_EMER_Pin GPIO_PIN_13
#define BOTON_EMER_GPIO_Port GPIOC
#define BOTON_REARME_Pin GPIO_PIN_14
#define BOTON_REARME_GPIO_Port GPIOC
#define MOTOR2_Pin GPIO_PIN_7
#define MOTOR2_GPIO_Port GPIOA
#define LED_ROJO_Pin GPIO_PIN_11
